...
function UserSubmit() {
  return (
    <div className="font-['lato'] text-black  flex flex-col items-center">
      <p className="text-2xl sm:text-3xl font-semibold mb-8 ">
        We have received your application! ✅
      </p>
      <p className="mb-8">We look forward to getting to know you!</p>
      <div className="flex flex-col items-center w-[440px] sm:w-[580px] lg:w-[1000px]">
        <img
          className="sm:w-[480px] sm:h-[280px] md:w-[600px] md:h-[340px] md:h-[280px] w-[400px] h-[240px] rounded-md mb-8"
...
<div className="py-8 w-[40px]">
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
     ...
     <p className="text-center text-2xl font-semibold mb-8">Here's what happens next:</p>
      <div className="flex flex-col  md:items-start md:flex-row   w-[400px] md:w-[700px] lg:w-[800px] sm:w-[500px]">
        
        <div className="flex flex-col justify-center items-start w-[600px]">
      
        <div className="flex flex-col items-start space-y-6 text-[#575B60] mb-10 w-full">
          <div className="flex flex-row space-x-4">
            <p className="text-3xl">📃</p>
            <div className="flex flex-col w-[360px] sm:max-md:w-[500px] md:max-xl:w-[300px]">
          ...
          <div className=" flex flex-row space-x-3 w-[440px] sm:max-md:w-[500px] md:max-xl:w-[400px]">
      ...
      <button className="w-full sm:w-[400px] h-[50px] rounded-md bg-[#222F65] text-white text-bold text-xl">
          To Our Career Section
        </button>
        <p className="mt-6 underline text-[#222F65]">Recruiting by OD Solutions GmbH</p>
    </div>
  );
}
